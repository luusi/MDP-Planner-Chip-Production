...
def process_services(mode, dimension):
    ...
    if dimension == "small": # 14 services
        ...
        all_services = [
            ...
            build_generic_service_one_state(PACKAGING1_SERVICE_NAME, {PACKAGING}, DEFAULT_USA_REWARD),
            build_generic_service_one_state(PACKAGING2_SERVICE_NAME, {PACKAGING}, HIGH_USA_REWARD),
        ...
        all_services = [
            ...
            build_generic_service_one_state(TESTING1_SERVICE_NAME, {TESTING}, DEFAULT_USA_REWARD),
            build_generic_service_one_state(TESTING2_SERVICE_NAME, {TESTING}, HIGH_USA_REWARD),
...
def target_service_automata():
    ...
    transition_function = {
        ...
        "s17": {PACKAGING: ("s18", 1.0, 0), },
        "s18": {f"ch_{PACKAGING}": ("s0", 1.0, 0), }
    }
